...
//   return (
// 	<div className={` cursor-pointer hover:opacity-60 hover:scale-[.99] duration-300 ease-in-out transition-all flex flex-col gap-[10px] justify-center items-center w-full h-[230px] bg-[#f1f8fe] dark:bg-bg3 rounded-[6px] border-dashed border-2 border-[#084384] ${cn} `} >
        ...
        <div className={`flex flex-col gap-4 w-full ${cn} `}>
            ...
            {!multiple && images.length > 0 ? (
                <div className='relative w-full h-[230px]'>
                    <img src={images[0]} alt='Uploaded' className='w-full h-full p-[5px] rounded-[6px] object-contain  border-2 border-[#eee]' />
                ...
                <label className={`cursor-pointer hover:opacity-60 hover:scale-[.99] transition-all flex flex-col gap-2 justify-center items-center w-full h-[230px] bg-[#f1f8fe] dark:bg-bg3 rounded-[6px] border-dashed border-2 border-[#084384] dark:border-border1 ${cn}`}>
                ...
                <div className='grid grid-cols-4 gap-[10px] '>
                    {images.map((img, index) => (
                        <div key={index} className=' group rounded-md  hover:bg-red-200 duration-300 relative w-full min-h-[60px] p-[3px] overflow-hidden bg-[#eee] dark:bg-bg4 bg-opacity-40'>
                            <img src={img} alt='Uploaded' className=' group-hover:opacity-0 duration-300 w-full h-full rounded-[6px] object-contain' />
