                ...
                icon: (
                    <svg width='40' height='40' viewBox='0 0 40 40' fill='none' xmlns='http://www.w3.org/2000/svg'>
                        ...
                        <defs>
                            ...
                            <clipPath id='clip1_1_5529'>
                                <rect width='23' height='20' fill='white' transform='translate(8.375 10)' />
                            </clipPath>
                        </defs>
                    </svg>
                ),
            },
            {
                ...
                icon: (
                    <svg width='40' height='41' viewBox='0 0 40 41' fill='none' xmlns='http://www.w3.org/2000/svg'>
                        <rect y='0.5' width='40' height='40' rx='6' fill='#EAEFFE' />
                        <path d='M13 16.7455V27.9375H27V16.7455H23V23.5335L20 22.0335L17 23.5335V16.7455H13ZM12 28.9375V15.8535L14.416 12.9375H25.566L28 15.8915V28.9375H12ZM13.38 15.7455H26.6L25.077 13.9375H14.904L13.38 15.7455ZM18 16.7455V21.8985L20 20.8985L22 21.8985V16.7465L18 16.7455Z' fill='#244C97' />
                    </svg>
                ),
            },
            {
        ...
        <div className='pb-[40px] pt-[20px]'>
            ...
            <div className=' cShadow min-h-[100px] @max-xl:justify-center  flex-wrap bg-white p-[20px] rounded-[10px]  flex items-center justify-between gap-[10px]  '>
                <div className='flex items-center gap-[10px]'>
                    <h1 className=' @max-lg:text-center text-[#0f1728] dark:text-[#fff] duration-300  text-[27px] font-normal'> {t('product_details_with_id', { count: params.id })} </h1>
                </div>
                    ...
                    <Button
                        ...
                        icon={
                            <svg width='25' height='25' viewBox='0 0 25 25' fill='none' xmlns='http://www.w3.org/2000/svg'>
                                <path d='M15.5 6.4997L18.5 9.4997M13.5 20.4997H21.5M5.5 16.4997L4.5 20.4997L8.5 19.4997L20.086 7.9137C20.4609 7.53864 20.6716 7.03003 20.6716 6.4997C20.6716 5.96937 20.4609 5.46075 20.086 5.0857L19.914 4.9137C19.5389 4.53876 19.0303 4.32812 18.5 4.32812C17.9697 4.32812 17.4611 4.53876 17.086 4.9137L5.5 16.4997Z' stroke='white' stroke-linecap='round' stroke-linejoin='round' />
                            </svg>
                        }
                    />
                    <Button onclick={() => setisOpenPopup(true)} order={'order-[-1]  '} 
					cn={'bg-secondery  dark:bg-bg3 dark:border-border1 dark:border-[1px] '} name={t('stock_feeding')} 
					icon={<Image src={'/icons/plus.png'} alt='' width={20} height={20} />} />
                </div>
            </div>
            ...
            <div className=' grid grid-cols-3 @max-xl:grid-cols-2 @max-lg:!grid-cols-1 mt-[20px] gap-[20px] '>
                <div className=' p20 @xl:col-span-2 cShadow  bg-white p-[20px] rounded-[10px]'>
                    <div className='flex items-center border-b-[.5px] border-[#eeeeee] dark:border-border1 '>
                        {switchBtns.map((e, i) => (
                            <span onClick={() => setswitchName(e.value)} key={i} className={`max-w-fit px-[10px] flex items-center justify-center w-full h-[42px] duration-300  cursor-pointer hover:bg-opacity-90 ${e.value == switchName ? 'bg-secondery dark:bg-primary text-white' : 'bg-white dark:bg-bg4 text-[#637381] dark:text-[#fff]'}  text-base font-normal`}>
                                {' '}
                                {e.name}{' '}
                            </span>
                        ))}
                    ...
                    {switchName == 'details' &&
                        detailsProduct.map((e, i) => (
                            <div data-aos='fade-up' data-aos-delay={`${i}00`} key={i} className=' px-[10px] min-h-[45px] flex justify-between  items-center gap-[10px] odd:bg-[#f7f7f7] dark:odd:bg-bg4 '>
                                <span className='text-[#666666] dark:text-white flex-1 text-base font-normal'> {e.key} </span>
                                <span className='ltr:text-left rtl:text-right flex-1 text-[#333333] dark:text-white dark:text-opacity-80  text-base font-normal'> {e.value} </span>
                            </div>
                        ))}
                </div>
