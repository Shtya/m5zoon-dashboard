	...
	<div className='mt-[20px] mb-[80px] flex flex-col gap-[20px]' >
		...
		<div className=' cShadow min-h-[100px] @max-xl:justify-center  flex-wrap bg-white p-[20px] rounded-[10px]  flex items-center justify-between gap-[10px]  '>
                <div className='flex items-center gap-[10px]' >
                    <h1 className=' @max-lg:text-center text-[#0f1728] text-[27px] font-normal'> {t('my_withdrawals')} </h1>
				...
				<div className='flex items-center gap-[10px] flex-wrap ' >
					...
					<Button onclick={() => setisOpenPopup(true)} order={"order-[-1]  "} cn={"bg-secondery  "}  name={t("new_withdrawal")} icon={<Image src={"/icons/plus.png"} alt='' width={20} height={20} />} />
				</div>
